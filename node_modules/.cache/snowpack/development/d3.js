import { t as tickIncrement, e as extent$1, a as ticks, b as bisectRight, c as ascending$3, n as numbers, d as number$2, R as Rgb, r as rgbConvert, f as define, g as extend, C as Color, h as brighter, i as darker, j as hue$1, k as interpolateNumber, l as hsl$2, m as nogamma, o as interpolate$1, p as color, q as interpolateRgb, s as interpolateString, u as tickStep, v as sequence, w as geoStream, x as epsilon2$1, y as hypot, z as atan2$1, A as degrees$2, B as asin$1, D as noop$3, E as Adder, F as epsilon$5, G as cos$2, H as sin$2, I as sqrt$2, J as radians$1, K as tau$5, L as abs$3, M as pi$4, N as spherical, O as cartesian, P as cartesianNormalizeInPlace, Q as acos$1, S as merge, T as polygonContains, U as halfPi$3, V as atan, W as cartesianCross, X as cartesianDot, Y as cartesianScale, Z as cartesianAddInPlace, _ as sign$1, $ as log$1, a0 as tan, a1 as exp, a2 as pow$2, a3 as initRange, a4 as number$3, a5 as linearish, a6 as copy$1, a7 as format, a8 as transformer$3, a9 as identity$8, aa as continuous, ab as bisector, ac as initInterpolator, ad as interpolateRound, ae as rgbBasis, af as rgb } from './common/linear-efcc147e.js';
export { E as Adder, ao as FormatSpecifier, c as ascending, b as bisect, ah as bisectCenter, ag as bisectLeft, b as bisectRight, ab as bisector, p as color, e as extent, a7 as format, ak as formatDefaultLocale, am as formatLocale, al as formatPrefix, an as formatSpecifier, ai as fsum, as as geoArea, at as geoBounds, au as geoContains, av as geoDistance, aw as geoGraticule, ax as geoGraticule10, ay as geoInterpolate, az as geoLength, w as geoStream, l as hsl, o as interpolate, aA as interpolateArray, aB as interpolateBasis, aC as interpolateBasisClosed, aD as interpolateDate, k as interpolateNumber, aE as interpolateNumberArray, aF as interpolateObject, q as interpolateRgb, ae as interpolateRgbBasis, aG as interpolateRgbBasisClosed, ad as interpolateRound, s as interpolateString, aj as mean, S as merge, ap as precisionFixed, aq as precisionPrefix, ar as precisionRound, v as range, af as rgb, aH as scaleLinear, aI as tickFormat, t as tickIncrement, u as tickStep, a as ticks } from './common/linear-efcc147e.js';
...
function sort(values, f = ascending$3) {
  if (typeof values[Symbol.iterator] !== "function") throw new TypeError("values is not iterable");
  values = Array.from(values);
  if (f.length === 1) {
    f = values.map(f);
    return permute(values, values.map((d, i) => i).sort((i, j) => ascending$3(f[i], f[j])));
  }
...
function centroidLinePointFirst(lambda, phi) {
  lambda *= radians$1, phi *= radians$1;
  var cosPhi = cos$2(phi);
  x0 = cosPhi * cos$2(lambda);
  y0 = cosPhi * sin$2(lambda);
  z0 = sin$2(phi);
...
function rotationIdentity(lambda, phi) {
  return [abs$3(lambda) > pi$4 ? lambda + Math.round(-lambda / tau$5) * tau$5 : lambda, phi];
}

rotationIdentity.invert = rotationIdentity;

function rotateRadians(deltaLambda, deltaPhi, deltaGamma) {
  return (deltaLambda %= tau$5) ? (deltaPhi || deltaGamma ? compose(rotationLambda(deltaLambda), rotationPhiGamma(deltaPhi, deltaGamma))
...
function forwardRotationLambda(deltaLambda) {
  return function(lambda, phi) {
    return lambda += deltaLambda, [lambda > pi$4 ? lambda - tau$5 : lambda < -pi$4 ? lambda + tau$5 : lambda, phi];
  };
}
...
function compareIntersection(a, b) {
  return ((a = a.x)[0] < 0 ? a[1] - halfPi$3 - epsilon$5 : halfPi$3 - a[1])
       - ((b = b.x)[0] < 0 ? b[1] - halfPi$3 - epsilon$5 : halfPi$3 - b[1]);
}
...
function conicEqualAreaRaw(y0, y1) {
  ...
  if (abs$3(n) < epsilon$5) return cylindricalEqualAreaRaw(y0);
  ...
  project.invert = function(x, y) {
    var r0y = r0 - y,
        l = atan2$1(x, abs$3(r0y)) * sign$1(r0y);
    if (r0y * n < 0)
      l -= pi$4 * sign$1(x) * sign$1(r0y);
...
function conicConformalRaw(y0, y1) {
  ...
  function project(x, y) {
    if (f > 0) { if (y < -halfPi$3 + epsilon$5) y = -halfPi$3 + epsilon$5; }
    else { if (y > halfPi$3 - epsilon$5) y = halfPi$3 - epsilon$5; }
  ...
  project.invert = function(x, y) {
    var fy = f - y, r = sign$1(n) * sqrt$2(x * x + fy * fy),
      l = atan2$1(x, abs$3(fy)) * sign$1(fy);
    if (fy * n < 0)
      l -= pi$4 * sign$1(x) * sign$1(fy);
    return [l / n, 2 * atan(pow$2(f / r, 1 / n)) - halfPi$3];
  };
...
function conicEquidistantRaw(y0, y1) {
  ...
  if (abs$3(n) < epsilon$5) return equirectangularRaw;
  ...
  project.invert = function(x, y) {
    var gy = g - y,
        l = atan2$1(x, abs$3(gy)) * sign$1(gy);
    if (gy * n < 0)
      l -= pi$4 * sign$1(x) * sign$1(gy);
...
equalEarthRaw.invert = function(x, y) {
  ...
  for (var i = 0, delta, fy, fpy; i < iterations; ++i) {
    ...
    if (abs$3(delta) < epsilon2$1) break;
  }
  return [
...
naturalEarth1Raw.invert = function(x, y) {
  ...
  } while (abs$3(delta) > epsilon$5 && --i > 0);
  return [
...
function radial$1() {
  ...
  scale.range = function(_) {
    return arguments.length ? (squared.range((range = Array.from(_, number$3)).map(square)), scale) : range.slice();
  };
  ...
  function arc() {
    ...
    // Or is it a circular or annular sector?
      ...
      var a01 = a0,
          ...
          da1 = da,
          ap = padAngle.apply(this, arguments) / 2,
          rp = (ap > epsilon$4) && (padRadius ? +padRadius.apply(this, arguments) : sqrt$1(r0 * r0 + r1 * r1)),
...
function stack() {
  ...
  function stack(data) {
    ...
    for (i = 0, oz = array$4(order(sz)); i < n; ++i) {
      sz[oz[i]].index = i;
    }
  ...
  stack.order = function(_) {
    return arguments.length ? (order = _ == null ? none$2 : typeof _ === "function" ? _ : constant$9(Array.from(_)), stack) : order;
  };
...
function transform$1(node) {
  while (!node.__zoom) if (!(node = node.parentNode)) return identity$7;
  return node.__zoom;
}
...
export { Delaunay, Voronoi, active, arc, area$2 as area, areaRadial, autoType, axisBottom, axisLeft, axisRight, axisTop, bin, blob, brush, brushSelection, brushX, brushY, buffer, chord, chordDirected, chordTranspose, cluster, density as contourDensity, contours, count, create, creator, cross, csv$1 as csv, csvFormat, csvFormatBody, csvFormatRow, csvFormatRows, csvFormatValue, csvParse, csvParseRows, cubehelix, cumsum, basis as curveBasis, basisClosed as curveBasisClosed, basisOpen as curveBasisOpen, bundle as curveBundle, cardinal as curveCardinal, cardinalClosed as curveCardinalClosed, cardinalOpen as curveCardinalOpen, catmullRom as curveCatmullRom, catmullRomClosed as curveCatmullRomClosed, catmullRomOpen as curveCatmullRomOpen, curveLinear, linearClosed as curveLinearClosed, monotoneX as curveMonotoneX, monotoneY as curveMonotoneY, natural as curveNatural, step as curveStep, stepAfter as curveStepAfter, stepBefore as curveStepBefore, descending, deviation, difference, disjoint, dispatch, drag, dragDisable, yesdrag as dragEnable, dsv, dsvFormat, backInOut as easeBack, backIn as easeBackIn, backInOut as easeBackInOut, backOut as easeBackOut, bounceOut as easeBounce, bounceIn as easeBounceIn, bounceInOut as easeBounceInOut, bounceOut as easeBounceOut, circleInOut as easeCircle, circleIn as easeCircleIn, circleInOut as easeCircleInOut, circleOut as easeCircleOut, cubicInOut as easeCubic, cubicIn as easeCubicIn, cubicInOut as easeCubicInOut, cubicOut as easeCubicOut, elasticOut as easeElastic, elasticIn as easeElasticIn, elasticInOut as easeElasticInOut, elasticOut as easeElasticOut, expInOut as easeExp, expIn as easeExpIn, expInOut as easeExpInOut, expOut as easeExpOut, linear as easeLinear, polyInOut as easePoly, polyIn as easePolyIn, polyInOut as easePolyInOut, polyOut as easePolyOut, quadInOut as easeQuad, quadIn as easeQuadIn, quadInOut as easeQuadInOut, quadOut as easeQuadOut, sinInOut as easeSin, sinIn as easeSinIn, sinInOut as easeSinInOut, sinOut as easeSinOut, every, filter, center$1 as forceCenter, collide as forceCollide, link as forceLink, manyBody as forceManyBody, radial as forceRadial, simulation as forceSimulation, x$2 as forceX, y$2 as forceY, albers as geoAlbers, albersUsa as geoAlbersUsa, azimuthalEqualArea as geoAzimuthalEqualArea, azimuthalEqualAreaRaw as geoAzimuthalEqualAreaRaw, azimuthalEquidistant as geoAzimuthalEquidistant, azimuthalEquidistantRaw as geoAzimuthalEquidistantRaw, centroid as geoCentroid, circle as geoCircle, clipAntimeridian as geoClipAntimeridian, clipCircle as geoClipCircle, extent as geoClipExtent, clipRectangle as geoClipRectangle, conicConformal as geoConicConformal, conicConformalRaw as geoConicConformalRaw, conicEqualArea as geoConicEqualArea, conicEqualAreaRaw as geoConicEqualAreaRaw, conicEquidistant as geoConicEquidistant, conicEquidistantRaw as geoConicEquidistantRaw, equalEarth as geoEqualEarth, equalEarthRaw as geoEqualEarthRaw, equirectangular as geoEquirectangular, equirectangularRaw as geoEquirectangularRaw, gnomonic as geoGnomonic, gnomonicRaw as geoGnomonicRaw, identity$4 as geoIdentity, mercator as geoMercator, mercatorRaw as geoMercatorRaw, naturalEarth1 as geoNaturalEarth1, naturalEarth1Raw as geoNaturalEarth1Raw, orthographic as geoOrthographic, orthographicRaw as geoOrthographicRaw, index$2 as geoPath, projection as geoProjection, projectionMutator as geoProjectionMutator, rotation as geoRotation, stereographic as geoStereographic, stereographicRaw as geoStereographicRaw, transform as geoTransform, transverseMercator as geoTransverseMercator, transverseMercatorRaw as geoTransverseMercatorRaw, gray, greatest, greatestIndex, group, groups, hcl, hierarchy, bin as histogram, html, image, index, indexes, Blues as interpolateBlues, BrBG as interpolateBrBG, BuGn as interpolateBuGn, BuPu as interpolateBuPu, cividis as interpolateCividis, cool as interpolateCool, cubehelix$2 as interpolateCubehelix, cubehelix$3 as interpolateCubehelixDefault, cubehelixLong as interpolateCubehelixLong, discrete as interpolateDiscrete, GnBu as interpolateGnBu, Greens as interpolateGreens, Greys as interpolateGreys, hcl$2 as interpolateHcl, hclLong as interpolateHclLong, hsl$1 as interpolateHsl, hslLong as interpolateHslLong, hue as interpolateHue, inferno as interpolateInferno, lab$1 as interpolateLab, magma as interpolateMagma, OrRd as interpolateOrRd, Oranges as interpolateOranges, PRGn as interpolatePRGn, PiYG as interpolatePiYG, plasma as interpolatePlasma, PuBu as interpolatePuBu, PuBuGn as interpolatePuBuGn, PuOr as interpolatePuOr, PuRd as interpolatePuRd, Purples as interpolatePurples, rainbow as interpolateRainbow, RdBu as interpolateRdBu, RdGy as interpolateRdGy, RdPu as interpolateRdPu, RdYlBu as interpolateRdYlBu, RdYlGn as interpolateRdYlGn, Reds as interpolateReds, sinebow as interpolateSinebow, Spectral as interpolateSpectral, interpolateTransformCss, interpolateTransformSvg, turbo as interpolateTurbo, viridis as interpolateViridis, warm as interpolateWarm, YlGn as interpolateYlGn, YlGnBu as interpolateYlGnBu, YlOrBr as interpolateYlOrBr, YlOrRd as interpolateYlOrRd, interpolateZoom, interrupt, intersection, interval$1 as interval, formatIso as isoFormat, parseIso as isoParse, json, lab, lch, least, leastIndex, line, lineRadial$1 as lineRadial, linkHorizontal, linkRadial, linkVertical, local, map, matcher, max, maxIndex, median, min, minIndex, namespace, namespaces, nice, now, index$3 as pack, enclose as packEnclose, siblings as packSiblings, pairs, partition, path, permute, pie, piecewise, pointRadial, pointer, pointers, area$1 as polygonArea, centroid$1 as polygonCentroid, contains$1 as polygonContains, hull as polygonHull, length$2 as polygonLength, quadtree, quantile, quantileSorted, quantize, quickselect, areaRadial as radialArea, lineRadial$1 as radialLine, bates as randomBates, bernoulli as randomBernoulli, beta as randomBeta, binomial as randomBinomial, cauchy as randomCauchy, exponential as randomExponential, gamma as randomGamma, geometric as randomGeometric, int as randomInt, irwinHall as randomIrwinHall, lcg$1 as randomLcg, logNormal as randomLogNormal, logistic as randomLogistic, normal as randomNormal, pareto as randomPareto, poisson as randomPoisson, uniform as randomUniform, weibull as randomWeibull, reduce, reverse, ribbon$1 as ribbon, ribbonArrow, rollup, rollups, band as scaleBand, diverging as scaleDiverging, divergingLog as scaleDivergingLog, divergingPow as scaleDivergingPow, divergingSqrt as scaleDivergingSqrt, divergingSymlog as scaleDivergingSymlog, identity$5 as scaleIdentity, implicit as scaleImplicit, log as scaleLog, ordinal as scaleOrdinal, point as scalePoint, pow$1 as scalePow, quantile$1 as scaleQuantile, quantize$1 as scaleQuantize, radial$1 as scaleRadial, sequential as scaleSequential, sequentialLog as scaleSequentialLog, sequentialPow as scaleSequentialPow, sequentialQuantile as scaleSequentialQuantile, sequentialSqrt as scaleSequentialSqrt, sequentialSymlog as scaleSequentialSymlog, sqrt as scaleSqrt, symlog as scaleSymlog, threshold as scaleThreshold, time as scaleTime, utcTime as scaleUtc, scan, Accent as schemeAccent, scheme$l as schemeBlues, scheme as schemeBrBG, scheme$9 as schemeBuGn, scheme$a as schemeBuPu, category10 as schemeCategory10, Dark2 as schemeDark2, scheme$b as schemeGnBu, scheme$m as schemeGreens, scheme$n as schemeGreys, scheme$c as schemeOrRd, scheme$q as schemeOranges, scheme$1 as schemePRGn, Paired as schemePaired, Pastel1 as schemePastel1, Pastel2 as schemePastel2, scheme$2 as schemePiYG, scheme$e as schemePuBu, scheme$d as schemePuBuGn, scheme$3 as schemePuOr, scheme$f as schemePuRd, scheme$o as schemePurples, scheme$4 as schemeRdBu, scheme$5 as schemeRdGy, scheme$g as schemeRdPu, scheme$6 as schemeRdYlBu, scheme$7 as schemeRdYlGn, scheme$p as schemeReds, Set1 as schemeSet1, Set2 as schemeSet2, Set3 as schemeSet3, scheme$8 as schemeSpectral, Tableau10 as schemeTableau10, scheme$i as schemeYlGn, scheme$h as schemeYlGnBu, scheme$j as schemeYlOrBr, scheme$k as schemeYlOrRd, select, selectAll, selection, selector, selectorAll, shuffle, shuffler, some, sort, stack, diverging$1 as stackOffsetDiverging, expand as stackOffsetExpand, none$1 as stackOffsetNone, silhouette as stackOffsetSilhouette, wiggle as stackOffsetWiggle, appearance as stackOrderAppearance, ascending$2 as stackOrderAscending, descending$2 as stackOrderDescending, insideOut as stackOrderInsideOut, none$2 as stackOrderNone, reverse$1 as stackOrderReverse, stratify, styleValue as style, subset, sum, superset, svg, symbol, circle$2 as symbolCircle, cross$2 as symbolCross, diamond as symbolDiamond, square$1 as symbolSquare, star as symbolStar, triangle as symbolTriangle, wye as symbolWye, symbols, text, freedmanDiaconis as thresholdFreedmanDiaconis, scott as thresholdScott, thresholdSturges, day as timeDay, days as timeDays, timeFormat, defaultLocale as timeFormatDefaultLocale, formatLocale as timeFormatLocale, friday as timeFriday, fridays as timeFridays, hour as timeHour, hours as timeHours, newInterval as timeInterval, millisecond as timeMillisecond, milliseconds as timeMilliseconds, minute as timeMinute, minutes as timeMinutes, monday as timeMonday, mondays as timeMondays, month as timeMonth, months as timeMonths, timeParse, saturday as timeSaturday, saturdays as timeSaturdays, second as timeSecond, seconds as timeSeconds, sunday as timeSunday, sundays as timeSundays, thursday as timeThursday, thursdays as timeThursdays, tuesday as timeTuesday, tuesdays as timeTuesdays, wednesday as timeWednesday, wednesdays as timeWednesdays, sunday as timeWeek, sundays as timeWeeks, year as timeYear, years as timeYears, timeout$1 as timeout, timer, timerFlush, transition, transpose, tree, index$4 as treemap, binary as treemapBinary, treemapDice, resquarify as treemapResquarify, treemapSlice, sliceDice as treemapSliceDice, squarify as treemapSquarify, tsv$1 as tsv, tsvFormat, tsvFormatBody, tsvFormatRow, tsvFormatRows, tsvFormatValue, tsvParse, tsvParseRows, union, utcDay, utcDays, utcFormat, utcFriday, utcFridays, utcHour, utcHours, millisecond as utcMillisecond, milliseconds as utcMilliseconds, utcMinute, utcMinutes, utcMonday, utcMondays, utcMonth, utcMonths, utcParse, utcSaturday, utcSaturdays, second as utcSecond, seconds as utcSeconds, utcSunday, utcSundays, utcThursday, utcThursdays, utcTuesday, utcTuesdays, utcWednesday, utcWednesdays, utcSunday as utcWeek, utcSundays as utcWeeks, utcYear, utcYears, variance, version, defaultView as window, xml, zip, zoom, identity$7 as zoomIdentity, transform$1 as zoomTransform };
