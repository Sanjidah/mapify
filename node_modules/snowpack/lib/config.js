        ...
        if (build) {
            plugin.load = async (options) => {
                const result = await build({
                    ...options,
                    contents: await util_1.readFile(url_1.default.pathToFileURL(options.filePath)),
                }).catch((err) => {
...
function normalizeConfig(_config) {
    ...
    config.buildOptions.webModulesUrl = util_1.removeTrailingSlash(util_1.addLeadingSlash(config.buildOptions.webModulesUrl));
    ...
    if (config.experiments.optimize) {
        config.experiments.optimize = {
            entrypoints: (_a = config.experiments.optimize.entrypoints) !== null && _a !== void 0 ? _a : 'auto',
            preload: (_b = config.experiments.optimize.preload) !== null && _b !== void 0 ? _b : false,
            bundle: (_c = config.experiments.optimize.bundle) !== null && _c !== void 0 ? _c : false,
            manifest: (_d = config.experiments.optimize.manifest) !== null && _d !== void 0 ? _d : false,
            target: (_e = config.experiments.optimize.target) !== null && _e !== void 0 ? _e : 'es2020',
            minify: (_f = config.experiments.optimize.minify) !== null && _f !== void 0 ? _f : false,
        };
    }
    // new pipeline
